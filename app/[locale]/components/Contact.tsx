...
export default function Contact() {
  ...
  if (isMobile) {
    return (
      <section
        id="contact"
        className="flex flex-col bg-dark_brown_grey text-white"
      >
        <div className="w-full py-20 px-4 bg-dark-brown flex flex-col items-center text-center gap-8">
          <h2 ref={contactMobileTitle} className="grand_titre_s">
            {t("contact.title_mobile_1")}
            <br />
            {t("contact.title_mobile_2")}
          </h2>
          ...
          <div className="fixed inset-0 transparent bg-opacity-90 flex items-center justify-center z-50">
            <div className="w-full px-10 py-44 bg-beige_grey text-black text-center rounded-md shadow-lg relative">
              ...
              <p className="citations">
                {t("contact.success_message.title")}
                <br />
                {t("contact.success_message.title_2")}
              </p>
              <p className="body_text mt-4">
                {t("contact.success_message.description")}
              </p>
            </div>
          </div>
        )}
...
<section
  id="contact"
  className="h-[900px] flex flex-row bg-dark_brown_grey text-white"
>
  {/* Le parent du composant Image doit être relatif */}
  <div className="w-2/5 flex-shrink-0 relative h-full">
    <Image
